...
const PRICING = {
  ...
  covered_standard: {
    label: 'Covered',
    monthly: { amount: 119, label: '$119 / month' },
    annual: {
      amount: 1190,
      label: '$1,190 / year',
      perMonthLabel: "That's $99/mo avg — 2 months free",
    },
  },
  covered_enhanced: {
    label: 'Covered',
    monthly: { amount: 149, label: '$149 / month' },
    annual: {
      amount: 1490,
      label: '$1,490 / year',
      perMonthLabel: "That's $124/mo avg — 2 months free",
    },
  },
  complete_standard: {
    label: 'Complete',
    ...
    annual: {
      amount: 2190,
      label: '$2,190 / year',
      perMonthLabel: "That's $183/mo avg — 2 months free",
    },
  },
  complete_enhanced: {
    label: 'Complete',
    monthly: { amount: 259, label: '$259 / month' },
    annual: {
      amount: 2590,
      label: '$2,590 / year',
      perMonthLabel: "That's $216/mo avg — 2 months free",
    },
  },
}
